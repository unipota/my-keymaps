...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * | Ctlr |   A  |   S  |   D  |   F  |   G  |             |   H  |   J  |   K  |   L  |  ;+  |  :*  |
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * | Shift|   Z  |   X  |   C  |   V  |   B  |   N  |   B  |   N  |   M  |  ,<  |  .>  |  Up  |Enter |
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * | Alt  | GUI  | GUI  |Adjust|EISU  |Lower |Space |Space | Raise| KANA |  / | Left | Down |Right |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_BASE] = LAYOUT( \
    ...
    KC_LALT, KC_LGUI, KC_LGUI, ML_ADJ,  EISU,  ML_LOW, KC_SPC,  KC_SPC,  ML_RAI,    KANA,  KC_SLSH,  KC_LEFT, KC_DOWN, KC_RGHT  \
    ),
   ...
   */
  [_LOWER] = LAYOUT( \
    _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   XXXXXXX, XXXXXXX, KC_MINS, JP_CIRC, JP_YEN,  KC_DEL,\
